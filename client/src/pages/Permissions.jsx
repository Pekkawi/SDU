  ...
  return (
    <div>
        ...
        <form action="#">
          <div class="grid grid-cols-2 gap-5 mt-7">
            <input
              type="text"
              placeholder="Name*"
              className="w-full border-gray-300 rounded-lg shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-left py-3"
            />
            <input
              type="text"
          ...
          <div class="mt-5 flex flex-col items-center">
            <button class="w-full bg-purple-500 py-3 rounded-lg text-center text-white">
              Create Permission
            </button>
          </div>
        </form>
      ...
      <div className="px-8 pt-8 pr-8 sm:px-6 pb-6 border-2 rounded-lg border-[#e6ebf4] bg-white m-2">
        <TitleDescription
          header="Permissions"
          description="Available device groups"
        />
      </div>
    </div>
  );
